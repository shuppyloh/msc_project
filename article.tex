...
The contraposition result of \textsc{gpe} says that we can prevent all paths to o' through one of these conditions:
\begin{itemize}
\item Deny all direct paths leading into o' 
\end{itemize}
...
The contraposition result of \textsc{gpec} says that we can prevent all paths from o to o' through one of these conditions:
...
\subsubsection{Protection is about object-path denial}
\begin{logic}
...
\hrule
\end{logic}
, where we can always use \textsc{gpec} to expand indirect paths into direct capabilities till we reach the terminating origin o and recursively use the condition to expand the condition till we reach the terminating o'.\\
